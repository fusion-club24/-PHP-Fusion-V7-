...
$locale['global_199'] = "<strong>Hinweis:</strong> Du hast noch kein Admin-Passwort festgelegt, klicke auf <a href='".BASEDIR."edit_profile.php' title='Profil bearbeiten'>Profil bearbeiten</a> um eines zu setzen.";
...
$locale['global_442'] .= "dein Account auf ".$settings['sitename']." wurde wegen zuvieler Anfragen beziehungsweise Postings über die IP-Adresse ".USER_IP." gesperrt.\n";
