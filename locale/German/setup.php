...
$locale['230'] = "Gl&uuml;ckwunsch, Du hast erfolgreich PHP Fusion 7.02.07 (Updated Version) installiert.<br /><br />";
$locale['230'] .= "Jetzt kannst Du dich auf der rechten Seiten mit deinem Administrator-Account anmelden.<br />";
$locale['230'] .= "<strong>Wichtig: Stelle bitte noch die config.php auf die Schreibrechte CHMOD 444 ein und l&ouml;sche die setup.php</strong><br /><br />";
$locale['230'] .= "<strong>Fragen, Downloads und mehr:</strong><br /><br />";
$locale['230'] .= "<a href=\"http://phpfusion-deutschland.de\" target=\"_blank\">PHPFusion Deutschland</a><br />";
$locale['230'] .= "<a href=\"http://php-fusion.at\" target=\"_blank\">PHPFusion &Ouml;sterreich</a><br /><br />";
//$locale['230'] .= "<strong>Handbuch</strong><br />";
//$locale['230'] .= "<a href=\"http://phpfusion-deutschland.de/handbuch.html\" target=\"_blank\">PHPFusion Handbuch</a><br /><br />";
$locale['230'] .= "<strong>Copyright</strong><br />";
$locale['230'] .= "Powered by";
$locale['230'] .= " <a target=\"_blank\" href=\"http://www.php-fusion.co.uk/\">PHP-Fusion</a> ";
$locale['230'] .= "copyright &copy; 2002 - ".date("Y")." by Nick Jones. Released as free software without warranties under";
$locale['230'] .= " <a href=\"http://www.gnu.org/licenses/agpl-3.0.html\" target=\"_blank\">GNU Affero GPL</a> ";
$locale['230'] .= "v3.";
$locale['230'] .= "<br>";
$locale['230'] .= "<br>";
$locale['230'] .= "Deutsche Version powered by";
$locale['230'] .= " <a href=\"http://www.phpfusion-deutschland.de\" target=\"_blank\">PHPFusion Deutschland</a> ";
$locale['230'] .= "copyright &copy; 2013 - ".date("Y")."<br /><br /><br />";
$locale['230'] .= "<center><a href=\"http://phpfusion-deutschland.de\" target=\"_blank\"><img src=\"https://www.phpfusion-deutschland.de/images/setup_logo.png\"/></a></center>";  
...
$locale['default_timezone'] = "Europe/Berlin";
