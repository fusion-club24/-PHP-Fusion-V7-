...
if ($_REQUEST['stype'] == "custompages" || $_REQUEST['stype'] == "all") {
	$sortby = "page_title";
	...
	if ($rows != 0) {
		$items_count .= THEME_BULLET."&nbsp;<a href='".FUSION_SELF."?stype=custompages&amp;stext=".$_REQUEST['stext']."&amp;".$composevars."'>".$rows." ".($rows == 1 ? $locale['c401'] : $locale['c402'])." ".$locale['522']."</a><br />\n";
		$result = dbquery(
