...
$radio_button['members'] = "<label><input type='radio' name='stype' value='members'".($_REQUEST['stype'] == "members" ? " checked='checked'" : "")." onclick=\"display(this.value)\" /> ".$locale['m400']."</label>";
?>