...
if (isset($_POST['save'])) {
	...
	echo "</tr>\n<tr>\n";
	echo "<td valign='top' width='100' class='tbl' colspan='2'>".$locale['424']."</td>\n</tr>\n";
	echo "<tr>\n<td width='100%' class='tbl' colspan='2'><textarea name='page_content' cols='95' rows='15' class='textbox' style='width:98%'>".$page_content."</textarea></td>\n";
	echo "</tr>\n<tr>\n";
