...
if ($rows != 0) {
	...
	echo "<td class='tbl2' style='font-weight:bold;width:5%;'>".$locale['409']."</td>\n";
	...
	while ($data = dbarray($result)) {
		...
		echo "</td>\n";
		echo "<td class='".$row_color."' style='white-space:nowrap;' align='center'>".$data['error_level']."</td>\n";
...
echo "<div class='tbl-border center' style='width: 90%'><b>1</b> = E_ERROR, <b>2</b> = E_WARNING, <b>4</b> = E_PARSE, <b>8</b> = E_NOTICE, <b>16</b> = E_CORE_ERROR, <b>32</b> = E_CORE_WARNING, <b>64</b> = E_COMPILE_ERROR, <b>128</b> = E_COMPILE_WARNING, <b>256</b> = E_USER_ERROR, <b>512</b> = E_USER_WARNING, <b>1024</b> = E_USER_NOTICE, <b>2048</b> = E_STRICT, <b>4096</b> = E_RECOVERABLE_ERROR, <b>8192</b> = E_DEPRECATED, <b>16384</b> = E_USER_DEPRECATED</div>";
closetable();
...
if (isset($_GET['error_id']) && isnum($_GET['error_id'])) {
	...
	if (isset($data['error_line']) && isnum($data['error_line'])) {
		$count_tFC = is_array($thisFileContent) ? count($thisFileContent) : 1;
		if (($data['error_line'] + 10) <= $count_tFC) {
